...
#     - 자가용(전기·내연기관) 고속도로 정속 100km/h (시원님 잠정 승인)
...
TRANSPORT = [
    ...
    ("전기 승용차 (BEV)",                     125,    100,   "개인교통", "ITF(1.5°C 라이프스타일 가이드북 수록) 🟡 속도 잠정치"),
    ("자가용 (가솔린·디젤·하이브리드)",        161,    100,   "개인교통", "ITF(1.5°C 라이프스타일 가이드북 수록, 내연기관 승용차) 🟡 속도 잠정치"),
...
CAR_BASELINE = "자가용 (가솔린·디젤·하이브리드)"
CAR_SCORE_PER_HOUR = transport_score_map[CAR_BASELINE]
...
col3.metric(f"{CAR_BASELINE} 대비 절감",
